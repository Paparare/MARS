...
Examples:
  ...
  python benchmark_gpqa.py --data-file ./data/gpqa_diamond_train.csv --categories Physics Chemistry
    ...
    parser.add_argument('--enhanced-prompt-dir', type=str, default='gpqa_enhanced_prompts/enhanced_20260105_014250',
                        help='Directory containing enhanced prompts')
    parser.add_argument('--enhancement-type', type=str, default='all',
                        choices=['concise', 'specific', 'reasoning', 'all'],
                        help='Type of enhancement to use (use "all" to run baseline + all three enhancements and compare)')
    parser.add_argument('--target-strategy', type=str, default='zero_shot',
    ...
    if use_enhanced:
        ...
        print(f"  - Type: {args.enhancement_type}" + (" (will run baseline + all three)" if args.enhancement_type == 'all' else ""))
    ...
    if args.enhancement_type == 'all' and use_enhanced:
        ...
        # Then run each enhancement type
        ...
        baseline_acc = all_enhancement_results.get('baseline', {}).get('overall_accuracy', 0)

        print(f"\n{'Type':<15} {'Accuracy':>12} {'Correct':>10} {'Total':>10} {'vs Baseline':>15}")
        print(f"{'-' * 65}")

        for enh_type in ['baseline', 'concise', 'specific', 'reasoning']:
